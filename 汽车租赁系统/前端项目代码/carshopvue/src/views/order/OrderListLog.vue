<template>
  <div>
    <h2 style="color: black;text-align: left;">已经完成的订单</h2>
        ...
        <el-table-column align="right" width="300" >
          ...
          <template slot-scope="scope">
            ...
            <el-popconfirm
              ...
              <el-button type="danger"   slot="reference" icon="el-icon-delete" circle >删除</el-button>
            </el-popconfirm>
          </template>
  ...
  export default {
    ...
    methods: {
      ...
      showAllUsers() {  //异步请求显示所有数据
        ...
        axios.get("/order/queryAllFinishOrders" ).then(res => {
          console.log(res)
